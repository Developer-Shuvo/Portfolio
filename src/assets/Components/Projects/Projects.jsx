...
const Projects = () => {
  return (
    <div className="p-4">
      ...
      <div className="">
        {PROJECTS.map((project, index) => ( // Renamed 'Projects' to 'project' for clarity
          <div key={index} className="mb-8 border border-[#2f176f] border-0.5 p-4 flex flex-wrap lg:justify-center">
            {/* Project Image */}
            ...
            <div className="w-full max-w-xl lg:w-3/4">
              ...
              <p className="mb-4 text-stone-400">
                {project.description} {/* Changed from Projects.description */}
              </p>
